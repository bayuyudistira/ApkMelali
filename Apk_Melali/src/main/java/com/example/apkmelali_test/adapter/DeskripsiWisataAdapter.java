...
import com.example.apkmelali_test.activity.DeskripsiWisataDetailActivity;
import com.example.apkmelali_test.model.DeskripsiWisata;
...
public class DeskripsiWisataAdapter extends RecyclerView.Adapter<DeskripsiWisataAdapter.WisataViewHolder> {
    ...
    public void onBindViewHolder(@NonNull WisataViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(v.getContext(), DeskripsiWisataDetailActivity.class);
