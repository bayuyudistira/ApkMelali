...
public class DetailTiketBusAdapter extends BaseAdapter {
...
//    private ArrayList<String> tickets; //menyimpan daftar tiket dalam bentuk array list di variable tickets
    ...
    public DetailTiketBusAdapter(Context context, ArrayList<PemesananTiket> pemesananTikets /*ArrayList<String> tickets*/) {
