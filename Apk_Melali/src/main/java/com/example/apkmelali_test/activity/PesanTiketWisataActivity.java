...
import com.example.apkmelali_test.adapter.PlaceAdapter;
import com.example.apkmelali_test.R;
import com.example.apkmelali_test.model.Place;

import java.util.ArrayList;
import java.util.List;

public class PesanTiketWisataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(view -> {
            Intent intent = new Intent(PesanTiketWisataActivity.this, DashboardActivity.class);
        ...
        checkoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PesanTiketWisataActivity.this, DetailTiketWisataActivity.class);
