...
import com.example.apkmelali_test.adapter.DetailOrderBusAdapter;
import com.example.apkmelali_test.R;

import java.util.ArrayList;
import java.util.List;

public class DetailOrderBusActivity extends AppCompatActivity {

    private ImageButton backButton;
    private ListView customTicketView;
    private DetailOrderBusAdapter detailOrderBusAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(view -> {
            Intent intentBackButton = new Intent(DetailOrderBusActivity.this, DetailTiketBusActivity.class);
        ...
        detailOrderBusAdapter = new DetailOrderBusAdapter(this, busList);
        ...
        simpanButton.setOnClickListener(view -> {
            ...
            Intent intentPaymentButton = new Intent(DetailOrderBusActivity.this, DetailOrderBusActivity.class);
