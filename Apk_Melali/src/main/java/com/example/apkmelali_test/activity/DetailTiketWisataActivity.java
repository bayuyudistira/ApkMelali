...
import com.example.apkmelali_test.adapter.TicketAdapter;
...
public class DetailTiketWisataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(DetailTiketWisataActivity.this, "Data saved to database!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(DetailTiketWisataActivity.this, DetailBayarWisataActivity.class);
        ...
        backButton.setOnClickListener(view -> {
            Intent intent = new Intent(DetailTiketWisataActivity.this, PesanTiketWisataActivity.class);
            startActivity(intent);
        });
