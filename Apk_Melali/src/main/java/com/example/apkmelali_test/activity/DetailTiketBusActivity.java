...
import com.example.apkmelali_test.adapter.DetailTiketBusAdapter;
...
public class DetailTiketBusActivity extends AppCompatActivity {

    private ImageButton backButton;
    private ListView customTicketView;
    private DetailTiketBusAdapter tiketBusAdapter;
...
//        db = AppDatabase.getDatabase(this);
        ...
        backButton.setOnClickListener(view -> {
            Intent intentBackButton = new Intent(DetailTiketBusActivity.this, PesanTiketBusActivity.class);
...
//        ArrayList<String> selectedTickets = intent.getStringArrayListExtra("SELECTED_TICKETS");
        ...
        tiketBusAdapter = new DetailTiketBusAdapter(this, pemesananTikets);
        ...
        paymentButton.setOnClickListener(view -> {
            Intent intentPaymentButton = new Intent(DetailTiketBusActivity.this, DetailBayarBusActivity.class);
