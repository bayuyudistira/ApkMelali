...
import com.example.apkmelali_test.adapter.TiketBus_CustomAdapter;

import java.util.ArrayList;
import java.util.List;

public class PesanTiketBusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(view -> {
            Intent intent = new Intent(PesanTiketBusActivity.this, DashboardActivity.class);
            startActivity(intent);
        });

        checkoutButton.setOnClickListener(view -> {
            Intent intent = new Intent(PesanTiketBusActivity.this, DetailTiketBusActivity.class);
