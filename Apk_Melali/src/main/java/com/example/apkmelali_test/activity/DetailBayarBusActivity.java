...
public class DetailBayarBusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentButton.setOnClickListener(view -> {
            ...
            Intent intentPaymentButton = new Intent(DetailBayarBusActivity.this, DashboardActivity.class);
            startActivity(intentPaymentButton);

            Toast.makeText(DetailBayarBusActivity.this, "Berhasil!", Toast.LENGTH_SHORT).show();
        });
    }
