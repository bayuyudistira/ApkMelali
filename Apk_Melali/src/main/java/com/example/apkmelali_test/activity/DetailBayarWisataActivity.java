...
import com.example.apkmelali_test.adapter.PaymentAdapter;
...
public class DetailBayarWisataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(view -> {
            Intent intent = new Intent(DetailBayarWisataActivity.this, DetailTiketWisataActivity.class);
            startActivity(intent);
        });

        paymentButton.setOnClickListener(view -> {
            Intent intentPaymentButton = new Intent(DetailBayarWisataActivity.this, DashboardActivity.class);
            startActivity(intentPaymentButton);

            Toast.makeText(DetailBayarWisataActivity.this, "Berhasil!", Toast.LENGTH_SHORT).show();
        });
